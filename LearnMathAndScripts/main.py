...
game_screen = pygame.display.set_mode((globals.WIDTH, globals.HEIGHT), 0, 32)
itens = pygame.image.load('resources/images/itens.png')
folder_image = pygame.image.load('resources/images/folder.png')
...
while running:
    ...
    for folder in folders:
        Folder(folder[0], folder[1], game_screen, folder_image)
